...
/**
 * Provides custom implementation of object and object inspector for hypertable key.
 ...
 */
public interface HypertableKeyFactory extends HiveStoragePredicateHandler {

  /**
   * initialize factory with properties
   */
  void init(HypertableSerDeParameters hypertableParam, Properties properties) throws SerDeException;

  /**
   * create custom object inspector for hypertable key
   * @param type type information
   */
  ObjectInspector createKeyObjectInspector(TypeInfo type) throws SerDeException;

  /**
   * create custom object for hypertable key
   * @param inspector OI create by {@link HypertableKeyFactory#createKeyObjectInspector}
   */
