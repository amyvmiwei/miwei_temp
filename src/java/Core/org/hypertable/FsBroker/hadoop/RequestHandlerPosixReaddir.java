...
public class RequestHandlerPosixReaddir extends ApplicationHandler {

    static final Logger log = Logger.getLogger(
        "org.hypertable.FsBroker.hadoop");

    public RequestHandlerPosixReaddir(Comm comm, HadoopBroker broker, Event event) {
        super(event);
        mComm = comm;
        mBroker = broker;
    }
    ...
    public void run() {
        String fileName;
        ResponseCallbackPosixReaddir cb;
        cb = new ResponseCallbackPosixReaddir(mComm, mEvent);
        ...
        try {
            ...
            mBroker.PosixReaddir(cb, fileName);
        }
