...
#ifndef HYPERTABLE_FSBROKER_PROTOCOL_H
#define HYPERTABLE_FSBROKER_PROTOCOL_H
...
namespace Hypertable {
  ...
  namespace FsBroker {
    ...
    public:
      ...
      static CommBuf *create_posix_readdir_request(const String &fname);
      ...
      static const uint64_t COMMAND_POSIX_READDIR   = 18;
...
#endif // HYPERTABLE_FSBROKER_PROTOCOL_H
