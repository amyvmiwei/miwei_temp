...
/// @file
/// Definitions for Readdir response callback.
/// This file contains definitions for Readdir, a response callback class used
...
int Callback::Readdir::response(std::vector<Filesystem::Dirent> &listing) {
  CommHeader header;
  header.initialize_from_request_header(m_event->header);
  Parameters::Readdir params(listing);
