...
/// @file
/// Definitions for Flush request handler.
/// This file contains definitions for Flush, a server-side request handler
...
void Flush::run() {
  ...
  try {
    Request::Parameters::Flush params;
    params.decode(&ptr, &remain);
    m_broker->flush(&cb, params.get_fd());
  }
  catch (Exception &e) {
