...
/// This file contains declarations for PhantomPrepareComplete, a class for encoding and
/// decoding paramters to the <i>phantom prepare complete</i> %Master operation.

#ifndef Hypertable_Lib_Master_Request_Parameters_PhantomPrepareComplete_h
#define Hypertable_Lib_Master_Request_Parameters_PhantomPrepareComplete_h
...
namespace Parameters {
  ...
  /// %Request parameters for <i>phantom prepare complete</i> operation.
  class PhantomPrepareComplete : public Serializable {
  public:
    ...
    PhantomPrepareComplete(int64_t op_id, const string &location, int32_t plan_generation,
...
#endif // Hypertable_Lib_Master_Request_Parameters_PhantomPrepareComplete_h
