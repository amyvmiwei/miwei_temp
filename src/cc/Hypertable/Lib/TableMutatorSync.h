...
#ifndef HYPERTABLE_TABLEMUTATORSYNC_H
#define HYPERTABLE_TABLEMUTATORSYNC_H
...
namespace Hypertable {
   ...
   */
  class TableMutatorSync : public ReferenceCount {

  public:

    /**
     * Constructs the TableMutatorSync object
     *
     ...
     */
    TableMutatorSync(PropertiesPtr &props, Comm *comm, Table *table,
                     RangeLocatorPtr &range_locator, uint32_t timeout_ms,
                     uint32_t flags = 0);

    /**
     * Destructor for TableMutatorSync object
     * Make sure buffers are flushed and unsynced rangeservers get synced.
     */
    virtual ~TableMutatorSync();
  ...
  typedef intrusive_ptr<TableMutatorSync> TableMutatorSyncPtr;

} // namespace Hypertable

#endif // HYPERTABLE_TABLEMUTATORSYNC_H
