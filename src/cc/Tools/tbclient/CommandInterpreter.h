...
#ifndef Tools_tbclient_CommandInterpreter_h
#define Tools_tbclient_CommandInterpreter_h
...
namespace tbclient {
  ...
  /// Command interpreter for %tbclient
...
#endif // Tools_tbclient_CommandInterpreter_h
