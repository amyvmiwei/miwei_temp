 ...
 * </dl>
 */
public class ColumnFamilySpec implements org.apache.thrift.TBase<ColumnFamilySpec, ColumnFamilySpec._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unsetQualifier_index() {
    __isset_bit_vector.clear(__QUALIFIER_INDEX_ISSET_ID);
  }
  ...
  public boolean isSetQualifier_index() {
    return __isset_bit_vector.get(__QUALIFIER_INDEX_ISSET_ID);
  }

  public void setQualifier_indexIsSet(boolean value) {
    __isset_bit_vector.set(__QUALIFIER_INDEX_ISSET_ID, value);
  }
  ...
  public int compareTo(ColumnFamilySpec other) {
    ...
    ColumnFamilySpec typedOther = (ColumnFamilySpec)other;
    ...
    lastComparison = Boolean.valueOf(isSetAccess_group()).compareTo(typedOther.isSetAccess_group());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAccess_group()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.access_group, typedOther.access_group);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetValue_index()).compareTo(typedOther.isSetValue_index());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetValue_index()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.value_index, typedOther.value_index);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetQualifier_index()).compareTo(typedOther.isSetQualifier_index());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQualifier_index()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.qualifier_index, typedOther.qualifier_index);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
