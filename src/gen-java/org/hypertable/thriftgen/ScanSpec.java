...
public class ScanSpec implements org.apache.thrift.TBase<ScanSpec, ScanSpec._Fields>, java.io.Serializable, Cloneable, Comparable<ScanSpec> {
  ...
  public int hashCode() {
    ...
    boolean present_and_column_predicates = true && (isSetAnd_column_predicates());
    list.add(present_and_column_predicates);
    if (present_and_column_predicates)
      list.add(and_column_predicates);
