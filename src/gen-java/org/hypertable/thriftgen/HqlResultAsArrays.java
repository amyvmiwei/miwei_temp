          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.results = new ArrayList<String>(_list20.size);
              for (int _i21 = 0; _i21 < _list20.size; ++_i21)
              {
                String _elem22; // required
                _elem22 = iprot.readString();
                this.results.add(_elem22);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.cells = new ArrayList<List<String>>(_list23.size);
              for (int _i24 = 0; _i24 < _list23.size; ++_i24)
              {
                List<String> _elem25; // required
                {
                  org.apache.thrift.protocol.TList _list26 = iprot.readListBegin();
                  _elem25 = new ArrayList<String>(_list26.size);
    ...
    if (this.results != null) {
      if (isSetResults()) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (String _iter29 : this.results)
          {
