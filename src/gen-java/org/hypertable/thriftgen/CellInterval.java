...
public class CellInterval implements org.apache.thrift.TBase<CellInterval, CellInterval._Fields>, java.io.Serializable, Cloneable, Comparable<CellInterval> {
  ...
  private static final _Fields optionals[] = {_Fields.START_ROW,_Fields.START_COLUMN,_Fields.START_INCLUSIVE,_Fields.END_ROW,_Fields.END_COLUMN,_Fields.END_INCLUSIVE};
  ...
  public int hashCode() {
    ...
    boolean present_end_column = true && (isSetEnd_column());
    list.add(present_end_column);
    if (present_end_column)
      list.add(end_column);
