 ...
 * </dl>
 */
public class AccessGroupSpec implements org.apache.thrift.TBase<AccessGroupSpec, AccessGroupSpec._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(AccessGroupSpec other) {
    ...
    AccessGroupSpec typedOther = (AccessGroupSpec)other;
    ...
    lastComparison = Boolean.valueOf(isSetDefaults()).compareTo(typedOther.isSetDefaults());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDefaults()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.defaults, typedOther.defaults);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
