...
RowInterval = module.exports.RowInterval = function(args) {
  ...
  if (args) {
    if (args.start_row !== undefined) {
      this.start_row = args.start_row;
    }
    if (args.start_inclusive !== undefined) {
      this.start_inclusive = args.start_inclusive;
    }
    if (args.end_row !== undefined) {
      this.end_row = args.end_row;
    }
    if (args.end_inclusive !== undefined) {
      this.end_inclusive = args.end_inclusive;
    }
    if (args.start_row_binary !== undefined) {
      this.start_row_binary = args.start_row_binary;
    }
    if (args.end_row_binary !== undefined) {
...
ColumnPredicate = module.exports.ColumnPredicate = function(args) {
  ...
  if (args) {
    ...
    if (args.column_qualifier !== undefined) {
...
ScanSpec = module.exports.ScanSpec = function(args) {
  ...
  if (args) {
    if (args.row_intervals !== undefined) {
      this.row_intervals = args.row_intervals;
    }
    if (args.cell_intervals !== undefined) {
      this.cell_intervals = args.cell_intervals;
    }
    if (args.return_deletes !== undefined) {
    ...
    if (args.keys_only !== undefined) {
      this.keys_only = args.keys_only;
    }
    if (args.cell_limit !== undefined) {
      this.cell_limit = args.cell_limit;
    }
    if (args.cell_limit_per_family !== undefined) {
      this.cell_limit_per_family = args.cell_limit_per_family;
    }
    if (args.row_regexp !== undefined) {
      this.row_regexp = args.row_regexp;
    }
    if (args.value_regexp !== undefined) {
      this.value_regexp = args.value_regexp;
    }
    if (args.scan_and_filter_rows !== undefined) {
      this.scan_and_filter_rows = args.scan_and_filter_rows;
    }
    if (args.row_offset !== undefined) {
      this.row_offset = args.row_offset;
    }
    if (args.cell_offset !== undefined) {
      this.cell_offset = args.cell_offset;
    }
    if (args.column_predicates !== undefined) {
      this.column_predicates = args.column_predicates;
    }
    if (args.do_not_cache !== undefined) {
      this.do_not_cache = args.do_not_cache;
    }
    if (args.and_column_predicates !== undefined) {
...
MutateSpec = module.exports.MutateSpec = function(args) {
  ...
  if (args) {
    ...
    if (args.flush_interval !== undefined) {
...
NamespaceListing = module.exports.NamespaceListing = function(args) {
  ...
  if (args) {
    ...
    if (args.is_namespace !== undefined) {
...
ColumnFamilyOptions = module.exports.ColumnFamilyOptions = function(args) {
  ...
  this.counter = null;
  if (args) {
    if (args.max_versions !== undefined) {
      this.max_versions = args.max_versions;
    }
    if (args.ttl !== undefined) {
      this.ttl = args.ttl;
    }
    if (args.time_order_desc !== undefined) {
...
ColumnFamilySpec = module.exports.ColumnFamilySpec = function(args) {
  ...
  if (args) {
    ...
    if (args.access_group !== undefined) {
    ...
    if (args.value_index !== undefined) {
      this.value_index = args.value_index;
    }
    if (args.qualifier_index !== undefined) {
...
AccessGroupOptions = module.exports.AccessGroupOptions = function(args) {
  ...
  if (args) {
    ...
    if (args.compressor !== undefined) {
      this.compressor = args.compressor;
    }
    if (args.bloom_filter !== undefined) {
      this.bloom_filter = args.bloom_filter;
    }
    if (args.in_memory !== undefined) {
...
Schema = module.exports.Schema = function(args) {
  ...
  if (args) {
    if (args.access_groups !== undefined) {
      this.access_groups = args.access_groups;
    }
    if (args.column_families !== undefined) {
      this.column_families = args.column_families;
    }
    if (args.generation !== undefined) {
      this.generation = args.generation;
    }
    ...
    if (args.group_commit_interval !== undefined) {
      this.group_commit_interval = args.group_commit_interval;
    }
    if (args.access_group_defaults !== undefined) {
      this.access_group_defaults = args.access_group_defaults;
    }
    if (args.column_family_defaults !== undefined) {
      this.column_family_defaults = args.column_family_defaults;
    }
  }
};
Schema.prototype = {};
