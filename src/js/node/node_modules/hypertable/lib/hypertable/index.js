...
exports.Key.prototype.toString = function() {
  ...
  if (this.timestamp !== null && this.timestamp !== undefined) {
    if (this.timestamp instanceof exports.Timestamp)
      timestampField = ', timestamp=' + this.timestamp.toString();
    else {
      var tmpTimestamp = new exports.Timestamp(this.timestamp);
      timestampField = ', timestamp=' + tmpTimestamp.toString();
    }
  }
  var revisionField = '';
  if (this.revision !== null && this.revision !== undefined) {
    if (this.revision instanceof exports.Timestamp)
      revisionField = ', revision=' + this.revision.toString();
    else {
      var tmpTimestamp = new exports.Timestamp(this.revision);
