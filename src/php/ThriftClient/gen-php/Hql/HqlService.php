...
interface Hypertable_ThriftGen_HqlServiceIf extends Hypertable_ThriftGen_ClientServiceIf {
...
class Hypertable_ThriftGen_HqlServiceClient extends Hypertable_ThriftGen_ClientServiceClient implements Hypertable_ThriftGen_HqlServiceIf {
  ...
  {
    $args = new Hypertable_ThriftGen_HqlService_hql_exec_as_arrays_args();
    $args->ns = $ns;
    $args->command = $command;
    $args->noflush = $noflush;
    $args->unbuffered = $unbuffered;
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Hypertable_ThriftGen_HqlService_hql_exec_as_arrays_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new Hypertable_ThriftGen_HqlService_hql_exec_as_arrays_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new Hypertable_ThriftGen_HqlService_hql_query_as_arrays_args();
    $args->ns = $ns;
    $args->command = $command;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'Hypertable_ThriftGen_HqlService_hql_query_as_arrays_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new Hypertable_ThriftGen_HqlService_hql_query_as_arrays_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class Hypertable_ThriftGen_HqlService_hql_exec_as_arrays_args {
  static $_TSPEC;
...
class Hypertable_ThriftGen_HqlService_hql_exec_as_arrays_result {
  static $_TSPEC;
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new Hypertable_ThriftGen_HqlResultAsArrays();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
...
class Hypertable_ThriftGen_HqlService_hql_query_as_arrays_args {
  static $_TSPEC;
...
class Hypertable_ThriftGen_HqlService_hql_query_as_arrays_result {
  static $_TSPEC;
